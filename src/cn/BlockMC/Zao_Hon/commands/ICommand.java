...
public interface ICommand {
	...
	/**
	 * Gets the usage string for this command. This should be in the format of:
	 * "<command> <usage>"
	 * 
	 * @param label  This is either the name of the command or an alias if they used
	 *               one.
	 ...
	 * @param label  The command name or the alias that was used to specity this
	 *               command
